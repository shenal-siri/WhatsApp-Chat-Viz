...
list_punc = [punc for punc in string.punctuation if punc != ("[" or "]")]

# Create list of predefined unicode emojis
...
# Create list of basic stopwords
...
# Output to the chat file, line-by-line, in the WhatsApp chat export format for iOS
